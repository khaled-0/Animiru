...
class EpisodeRecognitionTest {
    ...
    fun `Basic Ep prefix`() {
        ...
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4: Misrepresentation", 4f)
    }
    ...
    fun `Basic Ep prefix with decimal`() {
        ...
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4.1: Misrepresentation", 4.1f)
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4.4: Misrepresentation", 4.4f)
    }
    ...
    fun `Basic Ep prefix with alpha postfix`() {
        ...
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4.a: Misrepresentation", 4.1f)
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4.b: Misrepresentation", 4.2f)
        assertEpisode(animeTitle, "Mokushiroku Alice Vol.1 Ep.4.extra: Misrepresentation", 4.99f)
    }
    ...
    fun `Episode containing dot v2`() {
        ...
        assertEpisode(animeTitle, "Vol.1 Ep.5v.2: Alones", 5f)
    }
    ...
    fun `Episode title with ep substring`() {
        ...
        assertEpisode(animeTitle, "Vol.1 Ep.1: March 25 (First Day Cohabiting)", 1f)
    }
    ...
    fun `Episode containing multiple zeros`() {
        ...
        assertEpisode(animeTitle, "Vol.001 Ep.003: Kaguya Doesn't Know Much", 3f)
    }
    ...
    fun `Episode title containing commas`() {
        ...
        assertEpisode(animeTitle, "One Piece Ep,123,extra", 123.99f)
    ...
    fun `Episode title containing hyphens`() {
        ...
        assertEpisode(animeTitle, "ep 122-a", 122.1f)
        assertEpisode(animeTitle, "Solo Leveling Ep.123-extra", 123.99f)
        assertEpisode(animeTitle, "Solo Leveling, 024-005", 24.005f)
        assertEpisode(animeTitle, "Ep.191-200 Read Online", 191.200f)
    }
