...
class TrackHolder(private val binding: TrackItemBinding, adapter: TrackAdapter) : RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(item: TrackItem) {
        ...
        if (track != null) {
            ...
            binding.trackChapters.text = track.last_episode_seen.toInt().toString()
            ...
            if (supportsWatchingDates) {
                if (track.started_watching_date != 0L) {
                    ...
                    binding.trackStartDate.text = ctx.getString(R.string.track_started_date)
                ...
                if (track.finished_watching_date != 0L) {
                    ...
                    binding.trackFinishDate.text = ctx.getString(R.string.track_finished_date)
