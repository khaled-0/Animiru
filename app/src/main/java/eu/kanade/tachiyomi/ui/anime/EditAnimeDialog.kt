...
class EditAnimeDialog : DialogController {
    ...
    constructor(target: AnimeController, anime: Anime) : super(
        bundleOf(KEY_MANGA to anime.id!!),
    ) {
    ...
    constructor(bundle: Bundle) : super(bundle) {
        anime = Injekt.get<AnimeDatabaseHelper>().getAnime(bundle.getLong(KEY_MANGA))
            .executeAsBlocking()!!
    }
    ...
    fun onViewCreated() {
        ...
        if (isLocal) {
            ...
            binding.animeStudio.setText(anime.author.orEmpty())
            ...
            if (anime.author != anime.originalAuthor) {
                binding.animeStudio.append(anime.author.orEmpty())
            }
            ...
            if (anime.originalAuthor != null) {
                binding.animeStudio.hint = context.getString(R.string.studio_hint, anime.originalAuthor)
            }
    ...
    private fun onPositiveButtonClick() {
        infoController.presenter.updateAnimeInfo(
            ...
            binding.animeStudio.text.toString(),
