...
object LocaleHelper {
    ...
    fun getSourceDisplayName(lang: String?, context: Context): String {
        return when (lang) {
            AnimeSourcesPresenter.LAST_USED_KEY -> context.getString(R.string.last_used_source)
            AnimeSourcesPresenter.PINNED_KEY -> context.getString(R.string.pinned_sources)
