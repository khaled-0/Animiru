...
import eu.kanade.tachiyomi.data.database.tables.EpisodeTable.COL_FILLER
...
class EpisodeGetResolver : DefaultGetResolver<Episode>() {
    ...
    override fun mapFromCursor(cursor: Cursor): Episode = EpisodeImpl().apply {
        ...
        filler = cursor.getInt(cursor.getColumnIndexOrThrow(COL_FILLER)) == 1
