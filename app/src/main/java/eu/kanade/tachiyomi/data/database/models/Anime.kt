...
interface Anime : SAnime {
    ...
    var fillermarkedFilter: Int
        get() = episode_flags and EPISODE_FILLERMARKED_MASK
        set(filter) = setEpisodeFlags(filter, EPISODE_FILLERMARKED_MASK)
    ...
    companion object {
        ...
        const val EPISODE_SHOW_FILLERMARKED = 0x00000200
        const val EPISODE_SHOW_NOT_FILLERMARKED = 0x00000400
        const val EPISODE_FILLERMARKED_MASK = 0x00000600
